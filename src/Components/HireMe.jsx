...
export const HireMe = () => {
  return (
    <div className='flex flex-col md:flex-row justify-center items-center py-8 md:p-24 bg-gray-900 text-primary-60'>
        <div className='flex justify-center items-center p-6 rounded-full bg-primary-60 text-white'>
            <GrSend size={40} />
        </div>
        <div className='flex flex-col justify-center items-center max-w-[70%] p-4 text-center'>
            <Reveal>
            <h1 className='text-4xl font-bold'>HIRE ME FOR YOUR AWSOME PROJECT</h1>
            </Reveal>
            <Reveal>
